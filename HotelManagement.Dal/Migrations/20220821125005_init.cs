    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Pages",
                columns: new[] { "Id", "AllName", "AllRouterLink", "Color", "Description", "HomeWidget", "Icon", "MenuShow", "Name", "Order", "ParentId", "RouterLink", "WidgetIcon" },
                values: new object[] { 4, "Yönetim Paneli / İdari İşler/ Kullanıcı İşlemleri", "/yonetim/idari-isler/kullanici-islemleri", null, null, false, "fa fa-user", true, "Kullanıcı İşlemleri", (short)1, 3, "/kullanici-islemleri", null });
