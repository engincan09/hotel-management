namespace HotelManagement.Bll.Helpers
{
    public static class SystemConstants
    {
        #region Api Dönüş Mesajları
        //Ekleme
        ...
        public static string DeletedErrorMessage = "Silme İşlemi Gerçekleşemedi! Lütfen Sistem Yöneticinizle İletişime Geçiniz!";
        //Güncelleme
        ...
        public static string ListedErrorMessage = "Listeleme Yapılırken Bir Sorun Oluştu!";
